...
const slides = [
  {
    ...
    description: "Using the power of sport to inspire hope, discipline, and opportunity"
  },
  {
    image: hero2,
    title: "Mentorship That Transforms Lives",
    description: "Connecting young players with experienced coaches and leaders"
  },
  {
    image: hero3,
    title: "Building Champions On and Off the Field",
    description: "Creating pathways to education, opportunity, and success"
  }
];
